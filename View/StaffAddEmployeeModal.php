...
<div id="AddEmployeeModal" class="modal fade" tabindex="-1" aria-labelledby="modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <form action="../Controller/StaffAddEmployeeModalController.php?status=true" method="post">

                <div class="modal-header">
                    <h5 id="AddEmployeeModalTitle" class="modal-title">Add a new employee</h5>
