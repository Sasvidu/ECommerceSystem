...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../CSS/PasswordResetStylesUtil.css">
	...
	<div class="limiter">
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<form action="../Controller/UserPasswordResetController.php?status=true" method="post" class="login100-form validate-form">
