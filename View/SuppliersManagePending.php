...
if(isset($_POST['limitSelector'])){
    $_SESSION['limitPending'] = $_POST['limitSelector'];
    $limit = $_POST['limitSelector'];
    $page = 1;
}else{
    if(isset($_SESSION['limitPending'])){
        $limit = $_SESSION['limitPending'];
    }else{
        $_SESSION['limitPending'] = 10;
        $limit = 10;
    }
}
...
if (isset($_GET["search"])) {
    ...
    if ($resCheck > 0) {
        ...
        $msg = base64_encode($msg);
        header("location: ../View/SuppliersManagePending.php?msg=$msg");
        exit();
    }

} else {

    $sql = "SELECT * FROM supplier WHERE supplier_status = 1 AND supplier_pending_payment > 0 ORDER BY supplier_name, supplier_location LIMIT $start, $limit;";
    $result = $myCon->query($sql) or die($myCon->error);
    $resCheck = mysqli_num_rows($result);
...
$sqlNew = "SELECT count(supplier_id) AS supplier_id FROM supplier WHERE supplier_status = 1 AND supplier_pending_payment > 0;";
...
<head>
    ...
    <title>View Pending Payments</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="TitleTxt">View Pending Payments</h2>
            </div>
        </div>
                ...
                <nav class="paginationNav">
                    <ul class="pagination">
                        ...
                        <li class="page-item <?php if ($page == 1 || $page == 0) {
                            ...
                            <a class="page-link" href="SuppliersManagePending.php?page=<?php echo $previous; ?>">Previous</a>
                        </li>
                        ...
                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                            ...
                            <li class="page-item<?php if ($i == $page) {
                                ...
                                <a class="page-link" href="SuppliersManagePending.php?page=<?php echo $i; ?>"> <?php echo $i; ?> </a>
                            </li>
                        ...
                        <li class="page-item <?php if ($page == $pages || $page == 0) {
                            ...
                            <a class="page-link" href="SuppliersManagePending.php?page=<?php echo $next; ?>">Next</a>
                        </li>

                        <li class="page-item">
                            <a class="page-link" href="SuppliersManagePending.php?page=<?php echo $pages; ?>">Last</a>
                        </li>
                    ...
                    <tbody>
                        <?php foreach ($suppliers as $supplier) { ?>
                            <tr>
                                ...
                                <td id="pendingPayment<?php echo $supplier['supplier_id'] ?>">
                                    <h6><?php echo $supplier['supplier_pending_payment'] ?></h6>
                                </td>
                                <td>
