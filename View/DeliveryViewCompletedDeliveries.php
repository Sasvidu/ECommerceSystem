...
if(isset($_POST['limitSelector'])){
    $_SESSION['limitedCompletedDeliveries'] = $_POST['limitSelector'];
    $limit = $_POST['limitSelector'];
    $page = 1;
}else{
    if(isset($_SESSION['limitedCompletedDeliveries'])){
        $limit = $_SESSION['limitedCompletedDeliveries'];
    }else{
        $_SESSION['limitedCompletedDeliveries'] = 10;
        $limit = 10;
    }
}
...
if (isset($_GET["search"])) {
    ...
    $sql = "SELECT * FROM delivery JOIN deliveryagent ON delivery.delivery_agent_id = deliveryagent.agent_id WHERE CONCAT(delivery_id, delivery_scheduled_date, agent_name, agent_location) LIKE '%$filters%' AND delivery_status=1 ORDER BY delivery_status DESC, delivery_id ASC;";
    ...
    $sql = "SELECT * FROM delivery JOIN deliveryagent ON delivery.delivery_agent_id = deliveryagent.agent_id WHERE delivery_status=1 ORDER BY delivery_status DESC, delivery_id ASC LIMIT $start, $limit;";
    $result = $myCon->query($sql) or die($myCon->error);
    $resCheck = mysqli_num_rows($result);
...
$sqlNew = "SELECT count(delivery_id) AS delivery_id FROM delivery WHERE delivery_status=1";
...
<head>
    ...
    <title>View Completed Deliveries</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="TitleTxt">View Completed Deliveries</h2>
            </div>
            ...
            <div class="col-8">
                ...
                <nav class="paginationNav">
                    <ul class="pagination">
                        ...
                        <li class="page-item">
                            <a class="page-link" href="DeliveryViewCompletedDeliveries.php?page=1">First</a>
                        </li>

                        <li class="page-item <?php if ($page == 1 || $page == 0) {
                                                    echo "disabled";
                                                } ?>">
                            <a class="page-link" href="DeliveryViewCompletedDeliveries.php?page=<?php echo $previous; ?>">Previous</a>
                        </li>
                        ...
                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                            ...
                            <li class="page-item<?php if ($i == $page) {
                                ...
                                <a class="page-link" href="DeliveryViewCompletedDeliveries.php?page=<?php echo $i; ?>"> <?php echo $i; ?> </a>
                            </li>
                        ...
                        <li class="page-item <?php if ($page == $pages || $page == 0) {
                            ...
                            <a class="page-link" href="DeliveryViewCompletedDeliveries.php?page=<?php echo $next; ?>">Next</a>
                        </li>

                        <li class="page-item">
                            <a class="page-link" href="DeliveryViewCompletedDeliveries.php?page=<?php echo $pages; ?>">Last</a>
                        </li>
